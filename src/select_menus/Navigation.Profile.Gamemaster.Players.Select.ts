...
const selectMenu : SelectMenu = {
    customId: "navigation.profile.gamemaster.players.select",
    execute: async (interaction, gameID) => {
        ...
        const playerProfile = UserProfile.getFullProfile(playerID)
        const gamemasterGamesCount = playerProfile.gamemasterGames.length
        ...
        const row = new ActionRowBuilder<ButtonBuilder>()
            .addComponents(
                ...
                new ButtonBuilder()
                    ...
                    .setStyle(ButtonStyle.Secondary),
                new ButtonBuilder()
                    .setCustomId(`navigation.profile.gamemaster.players/${gameID}`)
