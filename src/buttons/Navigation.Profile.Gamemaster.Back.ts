...
const button : Button = {
    customId: "navigation.profile.gamemaster.back",
    execute: async (interaction, gameID) => {
        ...
        const embed = GameDataManager.generateGameInfoContent(game, undefined)
        ...
        const row1 = new ActionRowBuilder<ButtonBuilder>()
            .addComponents(
                ...
                new ButtonBuilder()
                    ...
                    .setStyle(ButtonStyle.Secondary),
                // new ButtonBuilder()
                //     .setCustomId("navigation.profile.gamemaster")
                //     .setLabel("Назад")
